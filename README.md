...
## Encode support (round 49 + r-multiref)
...
### P-frame inter encode (round 49 + r-next sub-pel ME + r-next partitions + r-next-8x8 16×16 HORZ/VERT + r-next-sub8 8×8 four-way RDO + r-multiref LAST/GOLDEN)
